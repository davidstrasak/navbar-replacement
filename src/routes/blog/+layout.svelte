<script lang="ts">
  ...
  <div class="min-h-screen font-primary flex flex-col selection:bg-secondary selection:text-black">
	  ...
	  {#if isOpen}
		<div class="md:hidden" transition:fly="{{ y: -200, duration: 300 }}">
		  <div class="mx-auto w-full md:w-4/5 lg:w-3/5">
				{#key page.url.pathname}
					<a href={`${base}/blog`} class="block py-2 px-4 text-sm hover:bg-base-gray-700 w-full text-left"> Blog </a>
				{/key}
				{#key page.url.pathname}
	...
	<main class="container mx-auto pt-20 xl:pt-24 font-primary fade-in">
	...
	<div class="container mx-auto font-primary fade-in flex-grow flex flex-col">
		<div class="mx-auto w-full md:w-4/5 lg:w-3/5 md:bg-base-100 p-6 h-full flex-grow"><!-- div that grows if the page is lesser than full screen --></div>
	...
	<div class="container mx-auto font-primary fade-in">
		<div class="mx-auto w-full md:w-4/5 lg:w-3/5 md:bg-base-100 p-6 py-0 shadow-lg">
		    <footer
		class=" order-1 footer items-center bg-base flex z-10 fade-in font-systemancer text-primary"
	>
		<!-- mt-60 -->
		...
		<nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
			...
			<a href="https://www.github.com/davidstrasak/" target="_blank" class="my-auto" aria-label="Github icon"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://www.linkedin.com/in/davidstrasak/" target="_blank" class="my-auto" aria-label="Linkedin icon"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
