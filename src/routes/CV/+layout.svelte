...
>
	...
	<footer
		class="mt-auto order-1 footer items-center p-4 bg-base flex z-10 fade-in font-systemancer text-primary"
	...
	>
		...
		<nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
			...
			<a href="https://www.github.com/davidstrasak/" target="_blank" class="my-auto" aria-label="GitHub link"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://www.linkedin.com/in/davidstrasak/" target="_blank" class="my-auto" aria-label="LinkedIn link"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
